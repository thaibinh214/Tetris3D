package com.sgu.tetris3d.game.math;
...
public class Matrix4f {
	 ...
	 */
	/*
	 * public static Vector4f transform(Matrix4f left, Vector4f right, Vector4f
	 * dest) { if (dest == null) dest = new Vector4f();
	 * 
	 * float x = left.m00 * right.x + left.m10 * right.y + left.m20 * right.z +
	 * left.m30 * right.w; float y = left.m01 * right.x + left.m11 * right.y +
	 * left.m21 * right.z + left.m31 * right.w; float z = left.m02 * right.x +
	 * left.m12 * right.y + left.m22 * right.z + left.m32 * right.w; float w =
	 * left.m03 * right.x + left.m13 * right.y + left.m23 * right.z + left.m33 *
	 * right.w;
	 * 
	 ...
	 */
	/*
	 * public Matrix4f translate(Vector2f vec) { return translate(vec, this); }
	 */
	 ...
	 * @return The rotated matrix
	 */
	public static Matrix4f rotate(float angle, Vector3f axis, Matrix4f src,
			Matrix4f dest) {
		if (dest == null)
			dest = new Matrix4f();
	 ...
	 */
	/*
	 * public Matrix4f translate(Vector2f vec, Matrix4f dest) { return
	 * translate(vec, this, dest); }
	 */
	 ...
	 */
	/*
	 * public static Matrix4f translate(Vector2f vec, Matrix4f src, Matrix4f
	 * dest) { if (dest == null) dest = new Matrix4f();
	 * 
	 * dest.m30 += src.m00 * vec.x + src.m10 * vec.y; dest.m31 += src.m01 *
	 * vec.x + src.m11 * vec.y; dest.m32 += src.m02 * vec.x + src.m12 * vec.y;
